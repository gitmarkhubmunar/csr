    ...
    render () {
		return (
             <div className="patient-alt-container-grid">
                <div></div>
                <div className="nested flex-center">
                     <div className="alt-header">Stay Tuned.</div>
                     <div className="alt-copy flex-center">We currently do not have a calculator or tables for {this.props.selectedCancer.name}.</div>
